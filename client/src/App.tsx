...
> = {
    ...
    admin: {
        ...
        description:
            "Administration area for managing memorial content and site updates.",
        noindex: true
    }
}
        ...
        switch (currentPage) {
            ...
            case "mission":
                return (
                    <Suspense
                        fallback={
                            <PageLoader label="Opening mission..." />
                        }
                    >
            ...
            case "gallery":
                return (
                    <Suspense
                        fallback={
                            <PageLoader label="Opening gallery..." />
                        }
                    >
            ...
            default:
                return (
                    <Suspense
                        fallback={
                            <PageLoader label="Opening section..." />
                        }
                    >
                        <SubPage
                            pageId={currentPage}
    ...
    return (
        <div className="min-h-screen bg-memorial spiritual-root">
            ...
            <Helmet>
                ...
                <meta
                    property="og:image"
                    content="https://www.srannalifamily.com/images/sister-anna-ali.jpg"
                />
                <meta
                    name="twitter:card"
